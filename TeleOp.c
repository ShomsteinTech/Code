...
Blog
Help
Jacob Shomstein ShomsteinTech
 
You don't have any verified emails. We recommend verifying at least one email.
Email verification helps our support team verify ownership if you lose account access and allows you to receive all the notifications you ask for.
1  Watch 
  Star 0
 Fork 1AASRobotics/Code
 branch: master  Code/TeleOp.c
Max BoenderMaxxb12 23 seconds ago Update TeleOp.c
1 contributor
122 lines (102 sloc)  4.776 kb RawBlameHistory   
#pragma config(Hubs,  S1, HTMotor,  HTServo,  none,     none)
#pragma config(Motor,  mtr_S1_C1_1,     ,              tmotorNone, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     ,              tmotorNone, openLoop)
//#pragma config(Motor, mtr_S1_C2_1),     ,              tmotorNone, openLoop) //DO THIS $%^& NOW (Find and configure motor)
...
task main()
{
  ...
  getJoystickSettings(joystick);
    ...
    {
      motor[motorE] = 0;                        // Motor E is stopped wtith a power level of 0.
    }
